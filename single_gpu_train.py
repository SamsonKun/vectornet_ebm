...
TRAIN_DIR = os.path.join('/home/zk/gitcode/dataset/argoverse_interm_data_vector_sample', 'forecasting_sample_intermediate')
# VAL_DIR = os.path.join('/home/zk/gitcode/dataset/argoverse_interm_data_vector', 'val_intermediate')
VAL_DIR = os.path.join('/home/zk/gitcode/dataset/argoverse_interm_data_vector_sample', 'forecasting_sample_intermediate')
SEED = 13
epochs = 50
